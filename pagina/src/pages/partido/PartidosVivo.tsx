...
const S = {
  ...
  liveDot: { width: 8, height: 8, borderRadius: "50%", background: "var(--ph-red-600)" },
  liveBadge: {
  ...
  scoreMinute: { color: "var(--ph-red-600)", fontWeight: 700, fontSize: "0.9rem" },
  ...
  tab: (active: boolean) => ({
    ...
    padding: "0.6rem 0",
    border: "none",
    borderRight: "1px solid var(--ph-border)",
    cursor: "pointer",
    background: active ? "var(--ph-red-600)" : "#fff",
    color: active ? "#fff" : "var(--ph-muted)",
  ...
  subsBtn: (active: boolean) => ({
    ...
    border: "none",
    borderRadius: 7,
    background: active ? "var(--ph-navy-700)" : "transparent",
    cursor: "pointer",
    display: "flex",
          ...
          {tab === "Alineaciones" && (
            <div>
              <div style={S.pitch}>
                ...
                <Shirt color="var(--ph-red-600)" x="95%" y="50%" />
                <Shirt color="var(--ph-red-600)" x="80%" y="15%" />
                <Shirt color="var(--ph-red-600)" x="80%" y="38%" />
                <Shirt color="var(--ph-red-600)" x="80%" y="62%" />
                <Shirt color="var(--ph-red-600)" x="80%" y="85%" />
                <Shirt color="var(--ph-red-600)" x="64%" y="25%" />
                <Shirt color="var(--ph-red-600)" x="64%" y="50%" />
                <Shirt color="var(--ph-red-600)" x="64%" y="75%" />
                <Shirt color="var(--ph-red-600)" x="50%" y="32%" />
                <Shirt color="var(--ph-red-600)" x="50%" y="65%" />
              </div>
              ...
              {loadingLineups ? (
                ...
                <div style={S.lineupGrid}>
                  <div style={{ borderRight: "1px solid #f0f0f0" }}>
                    <p style={S.lineupTitle("var(--ph-navy-700)")}>{match.homeTeam.name}</p>
                  ...
                  <div>
                    <p style={S.lineupTitle("var(--ph-red-600)")}>{match.awayTeam.name}</p>
                ...
                <>
                  ...
                  {stats.map((s, idx) => (
                    <div key={`${s.label}-${idx}`} style={S.statRow}>
                      <span style={{ fontWeight: 700, color: "var(--ph-navy-700)" }}>
                        {s.home_value}
                      </span>
                      <span
                        style={{
                  ...
                  {h2h.map((item, idx) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <strong style={{ color: "var(--ph-navy-700)" }}>
