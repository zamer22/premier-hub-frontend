...
export default function Partido() {
  ...
  const [pasados, setPasados] = useState<PastMatch[]>([]);
              ...
              <table className="partido_table">
                <thead>
                  <tr className="partido_table-head-row">
                    {["#", "Equipo", "PJ", "G", "E", "P", "GF", "GC", "DG", "Últimos 5", "Pts"].map((h) => (
                      <th key={h} className={h === "Últimos 5" ? "partido_th partido_th--form" : "partido_th"}>
                        {h}
                      </th>
                    ))}
                  </tr>
                    ...
                    <tr key={s.rank} className={i % 2 === 0 ? "partido_tr--even" : "partido_tr--odd"}>
                      ...
                      <td className="partido_td">
                        <div className="partido_team-cell">
                          <img src={s.team.logo} alt={s.team.name} className="partido_team-logo--small" />
